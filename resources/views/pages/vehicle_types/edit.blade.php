        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Edit Vehicle Type</div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h2 class="section-title text-primary m-0">Form Edit Vehicle Type</h2>
                            </div>
                            <form action="{{ route('vehicle-types.update', $type->id) }}" id="form_edit_vehicle_type" method="POST">
                                @csrf
                                @method('PUT')
...
@push('scripts')
    <!-- JS Libraies -->
    <script src="{{ asset('js/custom_js/pages/vehicle_types/vehicle_types_edit.js') }}"></script>
@endpush