        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Edit App Log</div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h2 class="section-title text-primary m-0">Form Edit App Log</h2>
                            </div>
                            <form action="{{ route('app-logs.update', $log->id) }}" id="form_edit_app_log" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="card-body row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="action" value="{{ old('action', $log->action) }}" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="module" value="{{ old('module', $log->module) }}" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="ip_address" value="{{ old('ip_address', $log->ip_address) }}">
...
@push('scripts')
    <!-- JS Libraies -->
    <script src="{{ asset('js/custom_js/pages/app_logs/app_logs_edit.js') }}"></script>
@endpush