        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Create a Role</div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h2 class="section-title text-primary m-0">Form Create New Role</h2>
                            </div>
                            <form action="#" id="form_add_role" method="POST">
                                @csrf
...
@push('scripts')
    <script src="{{ asset('js/custom_js/pages/roles/roles_create.js') }}"></script>
@endpush
