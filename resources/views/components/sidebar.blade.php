<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <!-- Bookings Section - Different access based on role -->
            <li class="menu-header"><i class="fas fa-exchange-alt"></i> Transactions</li>
            
            @if(Auth::user()->role->name === 'admin')
            <!-- Admin: Full access to all booking features -->
            ...
            <!-- Approver: Access to bookings and approvals -->
            <li class="nav-item dropdown {{ Request::is('bookings') || Request::is('booking-approvals') ? 'active' : '' }}">
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-book"></i> <span>Bookings</span></a>
                <ul class="dropdown-menu">
                    <li class='{{ Request::is('bookings') ? 'active' : '' }}'>
                        <a class="nav-link" href="{{ route('bookings.index') }}"><i class="fas fa-book"></i> Bookings</a>
            ...
            @else
            <!-- User: Only access to bookings -->
            <li class='{{ Request::is('bookings') ? 'active' : '' }}'>
                <a class="nav-link" href="{{ route('bookings.index') }}"><i class="fas fa-book"></i> <span>Bookings</span></a>
            </li>
            @endif
            ...
            <li class='{{ Request::is('reports/bookings') ? 'active' : '' }}'>
                <a class="nav-link" href="{{ route('reports.bookings') }}"><i class="fas fa-file-excel"></i> <span>Report Bookings</span></a>
            </li>
